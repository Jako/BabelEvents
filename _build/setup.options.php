...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install BabelEvents</h2>

        <p>Thanks for installing BabelEvents. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade BabelEvents</h2>

        <p>BabelEvents will be upgraded. This open source extra was developed by
